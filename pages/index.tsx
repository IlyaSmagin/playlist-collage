...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="flex flex-col items-center justify-center mx-6 mt-3">
        <div
          className={
            "sm:w-2/3 md:w-1/3 aspect-square bg-zinc-800 relative flex flex-col items-center justify-center w-full"
          }
        >
          {showCanvasMenu ? (
            <div
          ...
          <div className="aspect-square collage-wrapper absolute flex flex-col items-center justify-center w-full mt-12 mb-12 z-10">
        ...
        <div className="text-while w-full mx-6 my-3">
          ...
          <input
            ...
            className="focus:placeholder:text-green-400 placeholder:text-gray-400 focus:border-green-400 bg-none focus:outline-none focus:caret-green-500 dark:highlight-white/5 bg-zinc-800 w-full px-8 py-2 mt-1 text-sm text-green-400 rounded-md appearance-none"
        ...
        <form className="flex flex-col items-center justify-center w-full mx-6 text-white">
          ...
          <input
            ...
            max="40"
            step="1"
            className="appearance-none bg-transparent color-gray-500 w-full mt-1.5"
          />
        </form>
        <button
          className={
